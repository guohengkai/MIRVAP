...
class TestAreaDistance(MacroBase):
    def getName(self):
        return 'Test Area Distance'
    def run(self, window = None):
        ...
        self.sheet = self.book.add_sheet('Area_Distance')
        for i in range(3):
        ...
        self.book.save(self.path + self.ini.file.savedir + 'Area_Distance.xls')
